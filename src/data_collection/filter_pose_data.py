...
--------
# 統計情報を表示
python src/data_collection/filter_pose_data.py -i output/pose_data.csv --stats

# track_id=3のデータのみを抽出
python src/data_collection/filter_pose_data.py -i output/pose_data.csv -o output/player3.csv --ids 3

# track_id=3と5のデータを抽出(カンマ区切り)
python src/data_collection/filter_pose_data.py -i output/pose_data.csv -o output/players.csv --ids 3,5
        """
    )
